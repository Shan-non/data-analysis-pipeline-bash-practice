...
results/isles.dat: data/isles.text scipts/wordcount.py
...
# Renders a report
report/count_report.hyml report/count_report_files: results/figure/isles.png results/figure/abyss.png results/figure/last.png results/figure/sierra.png
